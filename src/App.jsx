...
import RightArrow from "./logo/Arrow.png"
    ...
    <div className='bg-transparent min-h-screen  flex items-center flex-col'>
      ...
      <div className=' w-full  md:pl-4 md:pr-4 xl:pl-14 xl:pr-14 2xl:pl-44 2xl:pr-44 3xl:pl-56 3xl:pr-56 4xl:pl-72 4xl:pr-72'>
        <div className='w-full flex justify-between pt-10'>
            ...
            <div className='flex'>
              <button className='bg-white/10 backdrop-blur-sm pt-2 pb-2 pl-3 pr-3 rounded-lg w-48 font-sora text-white hover:bg-white/20 border border-white/20 hidden lg:block transition-all duration-300'>Purchase Now</button>
            </div>
        </div>
        ...
        <div className='w-full flex pt-32 pl-4 md:pl-0'>
          <div className='grid frid-rows-2 md:grid-cols-5 w-full'>
              <div className=' grid row-span-1 md:col-span-3 font-sora  '>
                  <h2 className='font-clash text-[#eee5ff] text-[25px] xl:text-[40px] md:text-[30px] lg:text-[34px]  font-semibold '>Turn Your Cursor Into A Colorful Magic Wand & Charm Your Visitors</h2>
        ...
        <div className='w-full flex flex-col items-center pt-24 pl-4 pr-4 sm:pl-0 sm:pr-0'>
           ...
           <h2 className='font-clash'>Apply On Any Section Or Enable For Whole Page</h2>
            </div>
        ...
        <div className='flex pt-24 flex-col items-center'>
            <div className='font-clash max-w-[460px] text-[#eee5ff] text-[39px] xl:font-semibold xl:text-[38px] text-center'>
