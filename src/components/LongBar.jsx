...
export default function LongBar(){
    return (
        <>
        <div className="w-full bg-[#0e0720] pt-5 pb-12 pl-20 pr-20 border-[2px]  rounded-3xl border-l-[#1d172e] border-r-[#1d172e] border-t-[#332c42] border-b-[#332c42]  flex flex-col items-center">
